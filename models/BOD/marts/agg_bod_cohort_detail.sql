...
,client_id
 ,datediff(week, SUB_DATE, operation_date) delay_week
 ,datediff(month,SUB_DATE, operation_date) delay_month
 ,datediff(day, SUB_DATE, operation_date) delay_day
,sub_date_tz
,ope.insta_id
,date_trunc('WEEK', SUB_DATE) as WEEKLY_COHORT
,date_trunc('WEEK', operation_date) as WEEKLY_EVENT
,date_trunc('MONTH', SUB_DATE) as MONTHLY_COHORT
,date_trunc('MONTH', operation_date) as MONTHLY_EVENT
from operations ope
...
,bpr.firm_name 
,client_id
 ,datediff(week, SUB_DATE, operation_date) 
 ,datediff(month,SUB_DATE, operation_date) 
 ,datediff(day, SUB_DATE, operation_date) 
,sub_date_tz
,ope.insta_id
,date_trunc('WEEK', SUB_DATE) 
,date_trunc('WEEK', operation_date) 
,date_trunc('MONTH', SUB_DATE) 
